...
import net.tyc.tycmod.entity.animations.ModAnimationDefinitions;
import net.tyc.tycmod.entity.custom.Zero;
import org.slf4j.Logger;

public class ZeroModel<T extends Entity> extends HierarchicalModel<T> {
    private final ModelPart rhino;
    private final ModelPart head;
    private static final Logger LOGGER = LogUtils.getLogger();


    public ZeroModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        LOGGER.info("TTTTTTTTTTTTTTTTTTTTTYYYYYYYYYYYYYYYYYYYYYYYYYYYCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCmodel layer is created");
